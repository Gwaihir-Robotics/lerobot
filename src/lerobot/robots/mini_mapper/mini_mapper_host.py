...
from .config_mini_mapper import MiniMapperConfig, MiniMapperHostConfig
from .mini_mapper import MiniMapper


class MiniMapperHost:
    def __init__(self, config: MiniMapperHostConfig):
...
def main():
    ...
    try:
        ...
        print("Shutting down MiniMapper Host.")
        robot.disconnect()
        host.disconnect()

    logging.info("Finished MiniMapper cleanly")
