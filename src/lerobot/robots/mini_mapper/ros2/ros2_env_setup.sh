...
log_info "=Ë Checking system requirements..."
...
log_info "=æ Installing ROS2 navigation packages..."
NAV_PACKAGES=(
...
log_info "=á Setting up Slamtech C1 lidar driver..."
...
log_info "™  Configuring environment setup..."
...
log_info ">ê Testing installation..."
...
echo ""
echo "=Ú Full documentation: $LEROBOT_ROOT/src/lerobot/robots/mini_mapper/lidar_navigation_setup.md"
echo ""
